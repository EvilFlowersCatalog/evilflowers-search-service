...
class MilvusClient:
    ...
    def _setup_collection(self):
        ...
        fields = [
            ...
            FieldSchema(name="section", dtype=DataType.VARCHAR, max_length=500),  # Increased for longer section names
            FieldSchema(name="chunk_index", dtype=DataType.INT64),
            FieldSchema(name="text", dtype=DataType.VARCHAR, max_length=Config.MILVUS_MAX_TEXT_LENGTH),  # Use config
        ...
        logger.info(f"Collection {collection_name} is ready (max text length: {Config.MILVUS_MAX_TEXT_LENGTH})")
    ...
    def insert_embeddings(
        ...
        # always delete by document_id before inserting to prevent duplicates
    ...
    # search through all the embeddings and return top_k entities - data with all the  stored fields
    def search(
        self,
